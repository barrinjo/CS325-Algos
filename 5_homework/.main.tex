...
\begin{tikzpicture}[
% nolabel/.style={circle,inner sep=2pt,fill=black},
label/.style={circle,draw = black, inner sep=2pt, fill=white},
]
  \node[label] (A) at (0,0) {};
  \node[label] (B) at (0,2) {};
  \node[label] (C) at (2,3) {};
  \node[label] (D) at (4,0) {$v$};
  
  \node[label] (a) at (6,0) {};
  \node[label] (b) at (6,2) {};
  \node[label] (c) at (8,3) {};
  \node[label] (d) at (10,0) {$v$};
  \node[label] (e) at (10,2) {$v'$};
